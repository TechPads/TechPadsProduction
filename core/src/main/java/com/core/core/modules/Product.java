...
public class Product {
    ...
    @Column(name = "pro_img", length = 500)
    ...
    @Column(name = "pro_mark", nullable = false, length = 100)
    private String proMark;

    @Column(name = "pro_status", nullable = false, length = 1, columnDefinition = "CHAR(1) DEFAULT 'A'")
